...
Literature review shows MediaPipe combined with Procrustes analysis offers an optimal balance of accuracy, speed, and hardware requirements for gesture-based control.
...
This chapter presented the core algorithms including MediaPipe-based hand detection, Procrustes analysis for gesture recognition, and action execution for mouse control.
